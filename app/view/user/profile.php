...
<div class="main"> 
        <div class="profile">
            ...
            <div class="info">
				...
				<span class="photo" data-title="Ваш друг не уделяет вам внимания? Отправьте ему этот незабываемый подарок!"> <a onclick="sendGift('1','/index.php?r=gift&a=addgift&add=<?php echo $data['name'];?>&gift=1')"><img src="image/gifts/gift1.png" width="100px" height="100px"></a></span>
                <span class="photo" data-title="Ваш друг сидит за компьютером и не выходит гулять? Отправьте ему этот подарок!"><a  onclick="sendGift('2','/index.php?r=gift&a=addgift&add=<?php echo $data['name'];?>&gift=2')"><img src="image/gifts/gift2.png" width="100px" height="100px"></a></span>
				<span class="photo" data-title="Ваш друг хвастается своей новой фоткой? Сделайте себе приятное, отправьте ему это!"> <a  onclick="sendGift('3','/index.php?r=gift&a=addgift&add=<?php echo $data['name'];?>&gift=3')"><img src="image/gifts/gift3.png" width="100px" height="100px"></a></span>
                </div>
